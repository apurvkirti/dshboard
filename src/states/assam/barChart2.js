...
export default function Clus(props) {
  ...
  function getname(fid) {
    if (fid === 7001) return "Technology-lab Civil";
    else if (fid === 7002) return "Workshop Civil";
    else if (fid === 8001) return "Technology-lab Delivery";
    else if (fid === 8002) return "Workshop Delivery";
    else if (fid === 9001) return "Technology-lab Installation";
