...
export default function Chart() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      axios.get(`${apiUrl}/college/test/?formCode=7000`, { headers }),
      axios.get(`${apiUrl}/college/test/?formCode=8000`, { headers }),
      axios.get(`${apiUrl}/college/test/?formCode=9000`, { headers }),
    ])
      .then((responses) => {
