    ...
    <Table className="ti" celled collapsing striped>
      <Table.Header>
        ...
        <Table.Row>
            ...
            <Table.HeaderCell className="th">Workstations and Monitors</Table.HeaderCell>
            <Table.HeaderCell className="th">Server</Table.HeaderCell>
            <Table.HeaderCell className="th">Distance Learning Classroom</Table.HeaderCell>
            <Table.HeaderCell className="th">IOT Kit</Table.HeaderCell>
            <Table.HeaderCell className="th">IOT Desktops</Table.HeaderCell>
            <Table.HeaderCell className="th">3D Printer Tech-1</Table.HeaderCell>
            <Table.HeaderCell className="th">3D Printer Tech-2</Table.HeaderCell>
            <Table.HeaderCell className="th">TechTools Product Design 1</Table.HeaderCell>
            <Table.HeaderCell className="th">TechTools Product Design 2</Table.HeaderCell>
            <Table.HeaderCell className="th">TechTools Product Verification 1</Table.HeaderCell>
            <Table.HeaderCell className="th">TechTools Product Verification 2</Table.HeaderCell>
            <Table.HeaderCell className="th">TechTools Advance Manufacturing</Table.HeaderCell>
            <Table.HeaderCell className="th">E-Learning Platform</Table.HeaderCell>
          </Table.Row>
      </Table.Header>
