      ...
      <Table className="td" celled collapsing striped>
        <Table.Header>
          ...
          <Table.Row>
            ...
            <Table.HeaderCell className="th">VFD_Machine</Table.HeaderCell>
            <Table.HeaderCell className="th">Plumbing Kit</Table.HeaderCell>
            <Table.HeaderCell className="th">CNC_Machine</Table.HeaderCell>
            <Table.HeaderCell className="th">VMC_Machine</Table.HeaderCell>
